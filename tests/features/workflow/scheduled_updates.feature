...
#    And I enter "09-19-1984" for "scheduled_update[form][inline_entity_form][update_timestamp][0][value][date]"
#    And I enter "08:57:00AM" for "scheduled_update[form][inline_entity_form][update_timestamp][0][value][time]"
